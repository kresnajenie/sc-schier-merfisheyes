...
export const toggleCellFilter = () => {
  ...
  toggleCellCheckbox.addEventListener("click", () => {
    ...
    cellCheckbox.style.display =
      cellCheckbox.style.display === "none" ? "block" : "none";
...
export const toggleGeneFilter = () => {
  ...
  toggleGeneRadio.addEventListener("click", () => {
    geneRadioContainer.style.display =
      geneRadioContainer.style.display === "none" ? "block" : "none";
...
export const toggleAtacFilter = () => {
  ...
  toggleATACRadio.addEventListener("click", () => {
    ...
    atacRadioContainer.style.display =
      atacRadioContainer.style.display === "none" ? "block" : "none";
...
export const toggleViolin = () => {
  ...
  toggleViolinRadio.addEventListener("click", () => {
    ...
    toggleViolinRadio.style.backgroundColor =
      toggleViolinRadio.style.backgroundColor === "white" ? "#282828" : "white";
    toggleViolinRadio.style.color =
      toggleViolinRadio.style.color === "black" ? "white" : "black";
...
export const toggleButton = () => {
  ...
  togglePointSize.addEventListener("click", () => {
    ...
    pointSizeSliderBox.style.display =
      pointSizeSliderBox.style.display === "none" ? "block" : "none";
  });
  ...
  toggleGenePercentile.addEventListener("click", () => {
    ...
    geneSliderBox.style.display =
      geneSliderBox.style.display === "none" ? "block" : "none";
  });
