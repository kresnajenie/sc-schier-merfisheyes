  ...
  try {
    ...
    if (params.has("celltype")) {
      ...
      const filteredCells = cells.filter((cell) =>
        Object.keys(ApiState.value.pallete).includes(cell)
      );
    ...
    if (params.has("gene")) {
      ...
      const filteredGenes = genes.filter((gene) =>
        ApiState.value.genes.includes(gene)
      );
